...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() {
        ...
        try {
            new File("./src/edu/ut/netclassestocopy").mkdirs();
            copyFile(new File("./src/edu/ut/netclasses/Cloud.java"), new File("./src/edu/ut/netclassestocopy/Cloud.txt"));
            copyFile(new File("./src/edu/ut/netclasses/Cloud.java"), new File("./src/edu/ut/netclassestocopy/Cloud.txt"));
            copyFile(new File("./src/edu/ut/netclasses/CloudController.java"), new File("./src/edu/ut/netclassestocopy/CloudController.txt"));
            copyFile(new File("./src/edu/ut/netclasses/CloudRemotable.java"), new File("./src/edu/ut/netclassestocopy/CloudRemotable.txt"));
            copyFile(new File("./src/edu/ut/netclasses/Main.java"), new File("./src/edu/ut/netclassestocopy/Main.txt"));
            copyFile(new File("./src/edu/ut/netclasses/NetworkManagerClient.java"), new File("./src/edu/ut/netclassestocopy/NetworkManagerClient.txt"));
            copyFile(new File("./src/edu/ut/netclasses/NetworkManagerServer.java"), new File("./src/edu/ut/netclassestocopy/NetworkManagerServer.txt"));
            copyFile(new File("./src/edu/ut/netclasses/Pack.java"), new File("./src/edu/ut/netclassestocopy/Pack.txt"));
            copyFile(new File("./src/edu/ut/netclasses/ResultPack.java"), new File("./src/edu/ut/netclassestocopy/ResultPack.txt"));
...
class Modify implements Runnable{
        ...
        public void run() {
            ...
            try {
                ...
                new File(client, "src/edu/ut/netclasses").mkdirs();

                try{
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/Cloud.txt"), new File(client, "src/edu/ut/netclasses/Cloud.java"));
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/CloudController.txt"), new File(client, "src/edu/ut/netclasses/CloudController.java"));
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/CloudRemotable.txt"), new File(client, "src/edu/ut/netclasses/CloudRemotable.java"));
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/NetworkManagerClient.txt"), new File(client, "src/edu/ut/netclasses/NetworkManagerClient.java"));
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/Pack.txt"), new File(client, "src/edu/ut/netclasses/Pack.java"));
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/ResultPack.txt"), new File(client, "src/edu/ut/netclasses/ResultPack.java"));
                }catch(Exception ex){
                    try{
                        copyFile(new File("./src/edu/ut/netclasses/Cloud.java"), new File(client, "src/edu/ut/netclasses/Cloud.java"));
                        copyFile(new File("./src/edu/ut/netclasses/CloudController.java"), new File(client, "src/edu/ut/netclasses/CloudController.java"));
                        copyFile(new File("./src/edu/ut/netclasses/CloudRemotable.java"), new File(client, "src/edu/ut/netclasses/CloudRemotable.java"));
                        copyFile(new File("./src/edu/ut/netclasses/NetworkManagerClient.java"), new File(client, "src/edu/ut/netclasses/NetworkManagerClient.java"));
                        copyFile(new File("./src/edu/ut/netclasses/Pack.java"), new File(client, "src/edu/ut/netclasses/Pack.java"));
                        copyFile(new File("./src/edu/ut/netclasses/ResultPack.java"), new File(client, "src/edu/ut/netclasses/ResultPack.java"));
                    }catch(Exception exx){
                    }
                }

                File NetInfo = new File(client, "src/edu/ut/netclasses/NetInfo.java");
                ...
                new File(server, "src/edu/ut/netclasses").mkdirs();

                try{
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/Cloud.txt"), new File(server, "src/edu/ut/netclasses/Cloud.java"));
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/CloudController.txt"), new File(server, "src/edu/ut/netclasses/CloudController.java"));
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/CloudRemotable.txt"), new File(server, "src/edu/ut/netclasses/CloudRemotable.java"));
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/Main.txt"), new File(server, "src/edu/ut/netclasses/Main.java"));
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/NetworkManagerClient.txt"), new File(server, "src/edu/ut/netclasses/NetworkManagerClient.java"));
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/NetworkManagerServer.txt"), new File(server, "src/edu/ut/netclasses/NetworkManagerServer.java"));
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/Pack.txt"), new File(server, "src/edu/ut/netclasses/Pack.java"));
                    copyFile2(this.getClass().getResourceAsStream("/edu/ut/netclassestocopy/ResultPack.txt"), new File(server, "src/edu/ut/netclasses/ResultPack.java"));

                }catch(Exception ex){
                    try{
                        copyFile(new File("./src/edu/ut/netclasses/Cloud.java"), new File(server, "src/edu/ut/netclasses/Cloud.java"));
                        copyFile(new File("./src/edu/ut/netclasses/CloudController.java"), new File(server, "src/edu/ut/netclasses/CloudController.java"));
                        copyFile(new File("./src/edu/ut/netclasses/CloudRemotable.java"), new File(server, "src/edu/ut/netclasses/CloudRemotable.java"));
                        copyFile(new File("./src/edu/ut/netclasses/Main.java"), new File(server, "src/edu/ut/netclasses/Main.java"));
                        copyFile(new File("./src/edu/ut/netclasses/NetworkManagerClient.java"), new File(server, "src/edu/ut/netclasses/NetworkManagerClient.java"));
                        copyFile(new File("./src/edu/ut/netclasses/NetworkManagerServer.java"), new File(server, "src/edu/ut/netclasses/NetworkManagerServer.java"));
                        copyFile(new File("./src/edu/ut/netclasses/Pack.java"), new File(server, "src/edu/ut/netclasses/Pack.java"));
                        copyFile(new File("./src/edu/ut/netclasses/ResultPack.java"), new File(server, "src/edu/ut/netclasses/ResultPack.java"));
                    }catch(Exception exx){
                    }
                }

                NetInfo = new File(server, "src/edu/ut/netclasses/NetInfo.java");
                writeNetworkAddress(NetInfo);
                ...
                try{
                    ...
                    while ((line = reader.readLine()) != null) {
                        if(line.indexOf("main.class") >= 0){
                            nbproject.append("main.class=edu.ut.netclasses.Main").append("\n");
                            IsMainClassSet = true;
                        }else
                    ...
                    if(!IsMainClassSet){
                        nbproject.append("\n").append("main.class=edu.ut.netclasses.Main").append("\n");
                    }
...
void writeNetworkAddress(File destPath){
        try {
            ...
            fe.write("package edu.ut.netclasses;\n\n");
